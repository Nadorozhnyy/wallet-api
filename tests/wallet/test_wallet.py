...
class TestWalletEndpoints:
    ...
    async def test_get_wallet_by_id_success(self, async_client: AsyncClient, wallet_uuid, mocker):
        wallet_data = {
            "id": str(wallet_uuid),
            "amount": 100
        }
    ...
    async def test_get_wallet_by_id_failed(self, async_client: AsyncClient, wallet_uuid, mocker):
    ...
    async def test_wallet_operation_deposit_success(self, async_client: AsyncClient, wallet_uuid, mocker):
        operation_data = {
    ...
    async def test_wallet_operation_withdraw_success(self, async_client: AsyncClient, wallet_uuid, mocker):
        operation_data = {
            "operation_type": "DEPOSIT",
            "amount": 200
        }
    ...
    async def test_wallet_operation_amount_failed(self, async_client: AsyncClient, wallet_uuid):
        operation_data = {
            "operation_type": "DEPOSIT",
            "amount": -50
        }
    ...
    async def test_wallet_operation_amount_zero_failed(self, async_client: AsyncClient, wallet_uuid):
        operation_data = {
            "operation_type": "DEPOSIT",
            "amount": 0
        }
    ...
    async def test_wallet_operation_operation_type_failed(self, async_client: AsyncClient, wallet_uuid):
        operation_data = {
